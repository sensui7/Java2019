...
public class AboutBitwiseOperators {
    ...
    public void dontMistakeEqualsForEqualsEquals() {
        ...
        // Make sure to use the correct equals
    }
    ...
    public void aboutBitShiftingLeftShift() {
        int leftShift = 0x80000000; // Is this number positive or negative? Negative, but will be 0 since leftmost bit disappears
    ...
    public void aboutBitShiftingRightUnsigned() {
        ...
        assertEquals(rightShiftNegativeStaysNegative, -0x8000000); //moves to the right by 1 BYTE which is 1 digit
