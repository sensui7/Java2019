...
public class AboutCasting {
    ...
    public void upcastWithInheritance() {
        ...
        assertEquals(parentReference instanceof Child, true); // upcast
    ...
    public void downcastWithInheritance() {
        ...
        Parent parentReference = (Parent) child; // Why do we need an explicit cast here? When you want child to reference a Parent
        Child childReference = (Child) parentReference; // Or here? When you want a parent to reference a child
    ...
    public void downcastAndPolymorphism() {
        ...
        // Explicit cast is still here, and I did expect it because
        // child now references a Child instance pointed to by a parent reference
    ...
    public void classCasting() {
        try {
            Object o = new Child();
            ((Sleepable) o).sleep(); // would this even compile without the cast? Because o may point to a Sleepable at runtime
