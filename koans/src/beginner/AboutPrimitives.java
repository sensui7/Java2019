...
public class AboutPrimitives {
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        ...
        // When we need to do operations and don't need all the memory in an integer or long
    }
    ...
    public void charSize() {
        assertEquals(Character.SIZE, 16); // 2 bytes for each character
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        assertEquals(1.0e3, 1000.0); // will have a decimal
        assertEquals(1E3, 1000.0); // will have a decimal
    }
