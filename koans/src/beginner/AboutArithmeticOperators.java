...
public class AboutArithmeticOperators {
    ...
    public void minusMinusVariableMinusMinus() {
        int i = 1;
        assertEquals(--i, 0); // Decrements before evaluating
        assertEquals(i, 0); // Still should be 0
        assertEquals(i--, 0); // Evaluate then decrement
        assertEquals(i, -1); // Should be negative 1 because of previous decrement
    }
