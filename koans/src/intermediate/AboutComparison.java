...
public class AboutComparison {
    ...
    public void compareObjects() {
        String a = "abc";
        String b = "bcd";
        assertEquals(a.compareTo(b), -1); // first string is less than second string lexicographically
        assertEquals(a.compareTo(a), 0);  // two strings are equal
        assertEquals(b.compareTo(a), 1); // first string is greater than second string lexicographically
    }
