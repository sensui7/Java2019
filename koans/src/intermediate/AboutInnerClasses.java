...
public class AboutInnerClasses {
    ...
    @Koan
    public void accessingOuterClassMembers() { //inner classes have access to private members of outer class
        Inner someObject = new Inner();
    ...
    public void creatingAnonymousInnerClasses() {
        ...
        //an anonymous class declaration is an expression, hence it must be a part of a statement.
