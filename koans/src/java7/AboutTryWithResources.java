...
public class AboutTryWithResources {
    ...
    public void supressException() {
        ...
        try {
            ...
            // essentially both messages are concatenated because
            // CloseException appears to be suppressed
            // AutoCloseable means that the object will be
            // closed at the end of the statement of try
